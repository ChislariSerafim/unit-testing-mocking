...
class InMemPaymentRopsitoryTest {
    ...
    void whenEditMessage_thenPaymentMessageChanges(){
        ...
        testPaymentRepository.save(testPayment1);
        Payment editedPayment = testPaymentRepository.editMessage(testPayment1.getPaymentId(), testMessage);

        assertThat(editedPayment.getMessage()).isEqualTo(testMessage);
    }
